...
namespace BMS.Models
{
    internal static class authtoken
    {
        ...
        internal static string GenerateToken(string username, string password, string ip, string userAgent, long ticks)
        {
        ...
        internal static bool IsTokenValid(string token, string ip, string userAgent)
        {
            bool result = false;
